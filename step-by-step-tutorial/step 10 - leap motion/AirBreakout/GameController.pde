...
class GameController implements KeySubscriber { 
  ...
  private void sendHandMovement(float x, float y) {
    log(this, "sending hand movement ");
    HandMovementMessage message = new HandMovementMessage(x, y);
    world.sendOscMessage(message);
  }
}
